...
export const booksList: Book[] = [
  // Old Testament
  { name: "Genesis", testament: "Old",available: true, chaptersCount: 50 },
  { name: "Exodus", testament: "Old",available: true, chaptersCount: 40 },
  { name: "Leviticus", testament: "Old",available: true, chaptersCount: 27 },
  { name: "Numbers", testament: "Old",available: true, chaptersCount: 36 },
  { name: "Deuteronomy", testament: "Old",available: true, chaptersCount: 34 },
  { name: "Joshua", testament: "Old",available: true, chaptersCount: 24 },
  { name: "Judges", testament: "Old",available: true, chaptersCount: 21 },
  { name: "Ruth", testament: "Old",available: true, chaptersCount: 4 },
  { name: "1 Samuel", testament: "Old",available: true, chaptersCount: 31 },
  { name: "2 Samuel", testament: "Old",available: true, chaptersCount: 24 },
  { name: "1 Kings", testament: "Old",available: true, chaptersCount: 22 },
  { name: "2 Kings", testament: "Old",available: true, chaptersCount: 25 },
  { name: "1 Chronicles", testament: "Old",available: true, chaptersCount: 29 },
  { name: "2 Chronicles", testament: "Old",available: true, chaptersCount: 36 },
  { name: "Ezra", testament: "Old",available: true, chaptersCount: 10 },
  { name: "Nehemiah", testament: "Old",available: true, chaptersCount: 13 },
  { name: "Esther", testament: "Old",available: true, chaptersCount: 10 },
  { name: "Job", testament: "Old",available: true, chaptersCount: 42 },
  { name: "Psalms", testament: "Old",available: true, chaptersCount: 150 },
  { name: "Proverbs", testament: "Old",available: true, chaptersCount: 31 },
  { name: "Ecclesiastes", testament: "Old",available: true, chaptersCount: 12 },
  { name: "Song of Solomon", testament: "Old",available: true, chaptersCount: 8 },
  { name: "Isaiah", testament: "Old",available: true, chaptersCount: 66 },
  { name: "Jeremiah", testament: "Old",available: true, chaptersCount: 52 },
  { name: "Lamentations", testament: "Old",available: true, chaptersCount: 5 },
  { name: "Ezekiel", testament: "Old",available: true, chaptersCount: 48 },
  { name: "Daniel", testament: "Old",available: true, chaptersCount: 12 },
  { name: "Hosea", testament: "Old",available: true, chaptersCount: 14 },
  { name: "Joel", testament: "Old",available: true, chaptersCount: 3 },
  { name: "Amos", testament: "Old", available: true, chaptersCount: 9 },
  { name: "Obadiah", testament: "Old",available: true, chaptersCount: 1 },
  { name: "Jonah", testament: "Old",available: true, chaptersCount: 4 },
  { name: "Micah", testament: "Old",available: true, chaptersCount: 7 },
  { name: "Nahum", testament: "Old",available: true, chaptersCount: 3 },
  { name: "Habakkuk", testament: "Old",available: true, chaptersCount: 3 },
  { name: "Zephaniah", testament: "Old",available: true, chaptersCount: 3 },
  { name: "Haggai", testament: "Old",available: true, chaptersCount: 2 },
  { name: "Zechariah", testament: "Old",available: true, chaptersCount: 14 },
  ...
  { name: "Acts", testament: "New", available: true, chaptersCount: 28 },
  { name: "Romans", testament: "New", available: true, chaptersCount: 16 },
  { name: "1 Corinthians", testament: "New", available: true, chaptersCount: 16 },
  { name: "2 Corinthians", testament: "New", available: true, chaptersCount: 13 },
  { name: "Galatians", testament: "New", available: true, chaptersCount: 6 },
  { name: "Ephesians", testament: "New", available: true, chaptersCount: 6 },
  { name: "Philippians", testament: "New", available: true, chaptersCount: 4 },
  { name: "Colossians", testament: "New", available: true, chaptersCount: 4 },
  { name: "1 Thessalonians", testament: "New", available: true, chaptersCount: 5 },
  { name: "2 Thessalonians", testament: "New", available: true, chaptersCount: 3 },
  { name: "1 Timothy", testament: "New", available: true, chaptersCount: 6 },
  { name: "2 Timothy", testament: "New", available: true, chaptersCount: 4 },
  { name: "Titus", testament: "New", available: true, chaptersCount: 3 },
  { name: "Philemon", testament: "New", available: true, chaptersCount: 1 },
  { name: "Hebrews", testament: "New", available: true, chaptersCount: 13 },
  { name: "James", testament: "New", available: true, chaptersCount: 5 },
  { name: "1 Peter", testament: "New", available: true, chaptersCount: 5 },
  { name: "2 Peter", testament: "New", available: true, chaptersCount: 3 },
  { name: "1 John", testament: "New",  available: true, chaptersCount: 5 },
  { name: "2 John", testament: "New", available: true, chaptersCount: 1 },
  { name: "3 John", testament: "New", available: true, chaptersCount: 1 },
  { name: "Jude", testament: "New", available: true, chaptersCount: 1 },
  { name: "Revelation", testament: "New", available: true, chaptersCount: 22 }
];
